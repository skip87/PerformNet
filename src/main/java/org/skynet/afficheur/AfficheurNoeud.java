...
public abstract class AfficheurNoeud extends AfficheurElement {
	public AfficheurNoeud(){
	}
	/*
	...
	public List<Rectangle2D> obtenirRectanglesTexteEnMetres(Graphics2D g2, ControlleurReseau controlleur, Noeud noeud){
	...
	*/
	 ...
	 */
	/*
	List<TexteNoeud> preRender(Graphics2D g2, ControlleurReseau controlleur, Noeud noeud){
		return null;
	}
	...
	protected void _afficheHighlight(Graphics2D g2, ControlleurReseau controlleur, Noeud noeud){
	...
	protected void _affiche(Graphics2D g2, ControlleurReseau controlleur, Noeud noeud){
		Point coord = controlleur.pixels(noeud.obtenirCoordonnees());
